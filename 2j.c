...
void saisiecases(cases p[122], pions j[21]){
...
void saisiedefaut(cases p[122],pions j[21],int nbj){
    base(p);
    j[1].pcase=1;
    j[2].pcase=2;
    j[3].pcase=3;
...
void test(cases p[122], pions j[21]){
    int i;
...
cases* pionsgrille(cases p[122],pions j[21]){
...
int identification(pions j[21], cases p[122], int i){
    int z;
    for(z=1;z<21;z++){
...
void testcolor(pions j[21],int i, cases p[122]){
    int z, temp=0;
    int couleur;
...
void occupation(cases p[122],pions j[21]){
    int i,k,temp=0;
    for(i=1;i<122;i++){
        temp=0;
        for(k=1;k<21;k++){
...
int dephg(cases p[122],pions j[21],int pion){
    int erreur,n;
...
}int depbg(cases p[122],pions j[21],int pion){
    int erreur;
    if(j[pion].pcase==1){
...
int dephd(cases p[122],pions j[21],int pion){
    int erreur;
...
int depbd(cases p[122],pions j[21],int pion){
    int erreur;
    if(j[pion].pcase==1){
        if(verifoccupation(p,j[pion].pcase+2)==1){
            p[j[pion].pcase].occupation=0;
...
int deplacement(cases p[122],pions j[21],int dep,int pion){
    int erreur=0;
    switch (dep)
    {
...
void restaurationsauvegarde(pions j[21]){
